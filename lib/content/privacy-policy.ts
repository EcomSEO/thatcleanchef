/**
 * English-language Privacy Policy content for ThatCleanChef.
 *
 * Comprehensive GDPR-aligned policy covering data collection, legal
 * bases (Art. 6), purposes, retention, recipients, transfers, and
 * data-subject rights (Art. 15-22). Per-locale expansion deferred
...
export const PRIVACY_POLICY = {
  ...
  sections: [
    ...
    {
      heading: "2. Legal basis for processing (GDPR Art. 6)",
      body: [
    ...
    {
      heading: "7. Your rights (GDPR Art. 15–22)",
      body: [
